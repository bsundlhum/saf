...
class CreateMessageTemplateTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('message_template', function (Blueprint $table) {
            ...
            $table->tinyInteger('is_send_mobile',false)->default(0)->comment('发送短信 1->是');
            $table->string('code_mobile',255)->comment('短信模板编号');
            $table->text('mobile_code_content')->comment('短信模板编号内容');
