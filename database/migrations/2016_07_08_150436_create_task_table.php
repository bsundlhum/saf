...
class CreateTaskTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('task', function (Blueprint $table) {
            ...
            $table->integer('worker_num', false)->nullable()->comment('服务商数量');
            ...
            $table->string('url', 255)->comment('来源链接');
            $table->string('site_name', 45)->comment('来源网站');
            $table->tinyInteger('type',false)->default(0)->comment('项目类型 0：发布项目 1：导入项目\n');
            $table->string('tag_name', 45)->comment('二级标签');
            $table->string('tag_pname', 45)->comment('一级标签');
