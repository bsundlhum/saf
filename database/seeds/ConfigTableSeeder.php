...
',
            ...
            121 =>
                array (
                    'id' => 140,
                    'alias' => 'site_close_desc',
                    'rule' => '很抱歉，您所访问的网站正在维护中',
                    'type' => 'site',
                    'title' => '网站关闭提示语',
                    'desc' => NULL,
                ),
        ...
        $info = \DB::table('config')->where('alias','kee_path')->first();
        if($info && $info->rule == 'openapi.jiaofutai.com/v1/'){
            \DB::table('config')->where('alias','kee_path')->update([
                 'rule' => 'openapi.kee.im/v1/'
            ]);
        }
