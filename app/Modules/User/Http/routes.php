...
Route::group(['middleware' => ['closeSite']], function() {
    ...
    Route::post('/user/ajaxGetCity', 'ShopController@ajaxGetCity')->name('ajaxGetCity');

    Route::post('/user/ajaxGetArea', 'ShopController@ajaxGetArea')->name('ajaxGetArea');
});


Route::group(['prefix' => 'user','middleware' => ['auth','closeSite']], function () {
