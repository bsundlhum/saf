...
class UserController extends ManageController
{
    ...
    public function postUserAdd(Request $request)
    {
        ...
        if ($status){
            ...
            return redirect('manage/userList')->with(['message' => '操作失败']);
        }
    ...
    public function checkEmail(Request $request){
        ...
        if($request->get('id')){
            $status = UserModel::where('email', $email)->where('id','!=',$request->get('id'))->first();
        }else{
    ...
    public function checkMobile(Request $request)
    {
        ...
        if($request->get('id')){
            $status = UserModel::where('mobile', $mobile)->where('id','!=',$request->get('id'))->first();
