        ...
        if($rightsInfo->object_type == 2){
            ...
            if($status){
                ...
                if($shopRightsTem){
                    ...
                    if($shopRightsTem->is_send_mobile == 1 && $shopRightsTem->code_mobile && $rightsInfo->from_mobile){
                        $scheme = ConfigModel::phpSmsConfig('phpsms_scheme');
                        $templates = [
                            $scheme => $shopRightsTem->code_mobile,
                        ];
                        ...
                        \SmsClass::sendSms($rightsInfo->from_mobile, $templates, $fromNewArr);
                    }
                    ...
                    if($shopRightsTem->is_send_mobile == 1 && $shopRightsTem->code_mobile && $rightsInfo->to_mobile){
                        $scheme = ConfigModel::phpSmsConfig('phpsms_scheme');
                        $templates = [
                            $scheme => $shopRightsTem->code_mobile,
                        ];
                        ...
                        \SmsClass::sendSms($rightsInfo->to_mobile, $templates, $toNewArr);
                    }
                }
            }
        }
