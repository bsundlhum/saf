...
Route::get('/manage/fileDelete', 'IndexController@fileDelete');
Route::post('/manage/fileUploads','IndexController@fileUpload');
...
Route::group(['prefix' => 'manage', 'middleware' => ['manageauth', 'RolePermission','systemlog']], function() {
    ...
    Route::get('/financeListExport', 'FinanceController@financeListExport')->name('financeListExportCreate');
    ...
    Route::get('/fastPub', 'TaskController@fastPub')->name('fastPub');
    Route::get('/pubTask', 'TaskController@pubTask')->name('pubTask');

    Route::get('/thirdTask', 'KeeController@thirdTask')->name('thirdTask');
...
Route::group(['prefix' => 'manage', 'middleware' => ['manageauth','systemlog']], function() {
    ...
    Route::get('/userFinanceListExport', 'FinanceController@userFinanceListExport')->name('userFinanceListExportCreate');
    Route::get('/financeStatement', 'FinanceController@financeStatement')->name('financeStatementList');
    Route::get('/financeRecharge', 'FinanceController@financeRecharge')->name('financeRechargeList');
    ...
    Route::post('checkMobile', 'UserController@checkMobile')->name('checkMobile');
    Route::get('/userEdit/{uid}', 'UserController@getUserEdit')->name('userUpdatePage');
    ...
    Route::post('/updateTag', 'KeeController@updateTag')->name('updateTag');
    Route::get('deleteFast/{id}','TaskController@deleteFast')->name('deleteFast');
    Route::post('fastTask','TaskController@saveFastTask')->name('saveFastTask');
});
...
Route::post('/manage/insertUserOpenIm', 'ConfigController@insertUserOpenIm');
