    ...
    <div class="clearfix ma-t20">
        ...
        <div class="col-sm-9  col-md-10  col-xs-8">
            <div class="col-sm-12 col-md-12 col-xs-12">
                <h3 class="ma-t25 pd-l20">
                    <img src="{!! Theme::asset()->url('img/KEE_logo.png') !!}" alt="" />&nbsp;&nbsp;&nbsp;&nbsp;接入项目协同工具</h3>
            </div>
            <div class="col-sm-12 col-md-12 col-xs-12">
                <p class="col-sm-11 lh-30 pd-l20">项目协同工具 —— 项目协作交付工作台，专为项目交易后交付场景的协同工具，以工具思维为雇主解决项目管控问题，实现项目成果最大化效益（了解更多请点击<a href="http://www.kee.im/home" target="_blank">www.kee.im</a>）</p>
            </div>
        ...
        <div class="col-sm-10 col-md-8  col-lg-12 ma-l50 ma-t50 pd-t20 pd-l54 bord">
            ...
            <div class="col-sm-8 col-md-7 col-xs-10 ma-t10">
                ...
                <div class="col-sm-10 text pd-l20">
                    <h5>进入项目协同工具管理悬赏项目或众包项目</h5>
                    <p>在详情页面点击【交付工作台】即可进入项目协同工具管理项目</p>
                </div>
            </div>
        </div>
