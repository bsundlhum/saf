        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="/manage/config/phone">
                    ...
                    <div class="form-group basic-form-bottom">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 懒人任务发布验证码： </label>

                        <div class="col-sm-4">
                            <input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-12" name="sendTaskCode" value="{{$sendTaskCode}}" />
                        </div>
                        <label class="col-sm-5 cor-gray87"><i class="fa fa-exclamation-circle cor-orange text-size18"></i> (懒人任务发布验证码 )</label>
                    </div>

                    <div class="form-group basic-form-bottom">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 懒人任务快速注册账号通知： </label>

                        <div class="col-sm-4">
                            <input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-12" name="sendUserPassword" value="{{$sendUserPassword}}" />
                        </div>
                        <label class="col-sm-5 cor-gray87"><i class="fa fa-exclamation-circle cor-orange text-size18"></i> (懒人任务快速注册账号通知 )</label>
                    </div>
