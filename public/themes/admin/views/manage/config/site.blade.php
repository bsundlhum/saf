...
<form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="/manage/config/site">
    ...
    <div class="form-group interface-bottom col-xs-12">
        ...
        <div class="col-sm-4">
            <input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-12" name="web_site" @if(isset($site['site_name']))value="{{$site['site_name']}}" @endif/>
        </div>
        ...
        <div class="col-sm-4">
            <input type="text" id="form-field-2" placeholder="" class="col-xs-10 col-sm-12" name="web_url" @if(isset($site['site_url']))value="{{$site['site_url']}}" @endif/>
        </div>
                ...
                <div class="position-relative">
                    ...
                    <div id="imgdiv2">
                        @if(isset($site['browser_logo']) &&$site['browser_logo'])
                            <img id="imgShow3" width="120" height="120" src="{{url($site['browser_logo'])}}" />
                        @else
    ...
    <div class="form-group interface-bottom col-xs-12">
        <label class="col-sm-1 control-label no-padding-right" for="form-field-1">网站角色名称</label>

        <div class="col-sm-4">
            <div class="block">
            　 发布方：<input type="text" name="site_employer" @if(isset($site['site_employer']) && !empty($site['site_employer']))value="{!! $site['site_employer'] !!}"@endif >
            </div>
            <div class="space-4"></div>
            <div class="block">
                承接方：<input type="text" name="site_employee" @if(isset($site['site_employee']) && !empty($site['site_employee']))value="{!! $site['site_employee'] !!}"@endif >
            </div>
        </div>
        <div class="col-sm-5 h5 cor-gray87"><i class="fa fa-exclamation-circle cor-orange text-size18"></i> 默认角色名称为雇主和威客</div>
    </div>
    <div class="form-group interface-bottom col-xs-12">
        <label class="col-sm-1 control-label no-padding-right" for="form-field-1">公司名称</label>

        <div class="col-sm-4">
            <input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-12" name="company_name" @if(isset($site['company_name']))value="{{$site['company_name']}}"@endif/>
        </div>
    ...
    <div class="form-group interface-bottom col-xs-12">
        ...
        <div class="col-sm-4">
            <input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-12" name="company_address" @if(isset($site['company_address']))value="{{$site['company_address']}}" @endif/>
        </div>
        <div class="col-sm-5 h5 cor-gray87"><i class="fa fa-exclamation-circle cor-orange text-size18"></i> 将显示在页面底部的联系方式处</div>
    </div>
    <div class="form-group interface-bottom col-xs-12">
        ...
        <div class="col-sm-4">
            <input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-12" name="phone" @if(isset($site['phone']))value="{{$site['phone']}}"@endif/>
        </div>
        <div class="col-sm-5 h5 cor-gray87"><i class="fa fa-exclamation-circle cor-orange text-size18"></i> 将显示在页面底部的联系方式处</div>
    </div>
    <div class="form-group interface-bottom col-xs-12">
        ...
        <div class="col-sm-4">
            <input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-12" name="Email" @if(isset($site['Email']))value="{{$site['Email']}}"@endif/>
        </div>
    ...
    <div class="form-group interface-bottom col-xs-12">
        ...
        <div class="col-sm-4">
            <input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-12" name="site_record_code" @if(isset($site['record_number']))value="{{$site['record_number']}}" @endif/>
        </div>
    ...
    <div class="form-group interface-bottom col-xs-12">
        ...
        <div class="col-sm-4">
            <input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-12" name="footer_copyright" @if(isset($site['copyright']))value="{{$site['copyright']}}"@endif/>
        </div>
    ...
    <div class="form-group interface-bottom col-xs-12">
        ...
        <div class="col-sm-4">
            <input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-12" name="customer_service_qq" @if(isset($basic['qq'])) value="{{$basic['qq']}}" @endif/>
        </div>
    </div>
    ...
    <div class="interface-bottom col-xs-12">
        ...
        <div class="form-group interface-bottom col-xs-12">
            <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 网站关闭提示语</label>

            <div class="col-sm-4">
                <input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-12" name="site_close_desc" @if(isset($site['site_close_desc'])) value="{{$site['site_close_desc']}}" @endif/>
            </div>
        </div>
    <div class="col-xs-12">
